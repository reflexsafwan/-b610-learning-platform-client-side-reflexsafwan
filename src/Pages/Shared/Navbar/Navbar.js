          ...
          <ul className="items-center hidden space-x-8 lg:flex ">
            <li>
              <Link
                ...
                title="Our product"
                className="font-medium tracking-wide text-gray-100 transition-colors duration-200 hover:text-sky-500"
              >
                Courses
              </Link>
            </li>
            <li>
              <Link className="font-medium tracking-wide text-gray-100 transition-colors duration-200 hover:text-sky-500">
                FAQ
              </Link>
            </li>
            <li>
                ...
                <div className="p-5 bg-white border rounded shadow-sm absolute top-0 left-0 w-full">
                  ...
                  <nav className="">
                    <ul className="space-y-4">
                      ...
                      <li>
                        <Link className="font-medium tracking-wide text-gray-700 transition-colors duration-200 ">
                          FAQ
                        </Link>
                      </li>
                      <li>
